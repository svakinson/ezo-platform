    ...
    <div className="min-h-screen bg-pastel-gradient overflow-hidden">
      ...
      <section className="relative min-h-screen flex items-center justify-center pt-20 pb-16 px-4">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <div className="absolute bottom-40 left-1/4 animate-cloud opacity-40" style={{animationDelay: '4s'}}>
        ...
        <div className="relative z-10 max-w-6xl mx-auto text-center">
          ...
          <div className="animate-scale-in">
            <h1 className="text-8xl md:text-9xl font-black text-white text-glow mb-6 tracking-tight">
              EZO
            </h1>
          </div>
            ...
            <div className="absolute inset-0 flex items-center justify-center transform-3d">
              ...
              <div className="animate-float relative">
                <svg width="180" height="220" viewBox="0 0 180 220" className="drop-shadow-2xl">
                  ...
                  <rect x="50" y="160" width="20" height="25" rx="2" fill="#e0f2fe" opacity="0.8"/>
                  <rect x="80" y="160" width="20" height="25" rx="2" fill="#e0f2fe" opacity="0.8"/>
                  <rect x="110" y="160" width="20" height="25" rx="2" fill="#e0f2fe" opacity="0.8"/>
                  {/* სახურავი */}
              ...
              {/* მარცხენა შენობა */}
              <div className="absolute left-0 md:left-10 top-10 animate-float-slow" style={{animationDelay: '1s'}}>
                <svg width="120" height="160" viewBox="0 0 120 160" className="drop-shadow-xl">
                  ...
                  <rect x="30" y="105" width="15" height="20" rx="2" fill="#e0f2fe" opacity="0.8"/>
                  <rect x="55" y="105" width="15" height="20" rx="2" fill="#e0f2fe" opacity="0.8"/>
                  <rect x="80" y="105" width="15" height="20" rx="2" fill="#e0f2fe" opacity="0.8"/>
              ...
              {/* მარჯვენა შენობა */}
              <div className="absolute right-0 md:right-10 top-20 animate-float-delayed" style={{animationDelay: '2s'}}>
                <svg width="140" height="180" viewBox="0 0 140 180" className="drop-shadow-xl">
                  ...
                  <rect x="30" y="115" width="18" height="22" rx="2" fill="#e0f2fe" opacity="0.8"/>
                  <rect x="60" y="115" width="18" height="22" rx="2" fill="#e0f2fe" opacity="0.8"/>
                  <rect x="90" y="115" width="18" height="22" rx="2" fill="#e0f2fe" opacity="0.8"/>
                  ...
                  <line x1="42" y1="10" x2="42" y2="25" stroke="#1e40af" strokeWidth="1"/>
                  <line x1="50" y1="10" x2="50" y2="25" stroke="#1e40af" strokeWidth="1"/>
                  <line x1="58" y1="10" x2="58" y2="25" stroke="#1e40af" strokeWidth="1"/>
                  <defs>
              ...
              {/* ხეები */}
              <div className="absolute left-10 md:left-20 bottom-0 animate-float-slow" style={{animationDelay: '0.5s'}}>
              ...
              <div className="absolute right-10 md:right-20 bottom-10 animate-float" style={{animationDelay: '1.5s'}}>
      ...
      <section id="features" className="py-20 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {/* ბარათი 1 */}
            <div className="card-3d glass-strong rounded-3xl p-8 text-center">
              <div className="text-6xl mb-4">💰</div>
              <h3 className="text-2xl font-bold text-gray-800 mb-3">ფინანსური მართვა</h3>
              <p className="text-gray-600">
                გადასახადების, ხარჯების და ბიუჯეტის სრული კონტროლი ერთ სივრცეში
              </p>
            </div>
            ...
            <div className="card-3d glass-strong rounded-3xl p-8 text-center">
              <div className="text-6xl mb-4"></div>
              <h3 className="text-2xl font-bold text-gray-800 mb-3">შეკეთებები</h3>
              <p className="text-gray-600">
                პრობლემების შეტყობინება და თვალყურის დევნება რეალურ დროში
              </p>
            </div>
            ...
            <div className="card-3d glass-strong rounded-3xl p-8 text-center">
              <div className="text-6xl mb-4">📊</div>
              <h3 className="text-2xl font-bold text-gray-800 mb-3">ანგარიშები</h3>
              <p className="text-gray-600">
                დეტალური ანგარიშები და ანალიტიკა გადაწყვეტილებების მისაღებად
              </p>
            </div>
            ...
            <div className="card-3d glass-strong rounded-3xl p-8 text-center">
              <div className="text-6xl mb-4">👥</div>
              <h3 className="text-2xl font-bold text-gray-800 mb-3">კომუნიკაცია</h3>
              <p className="text-gray-600">
                მეზობლებთან და მმართველ კომპანიასთან პირდაპირი კავშირი
              </p>
            </div>
            ...
            <div className="card-3d glass-strong rounded-3xl p-8 text-center">
              <div className="text-6xl mb-4">🔒</div>
              <h3 className="text-2xl font-bold text-gray-800 mb-3">უსაფრთხოება</h3>
              <p className="text-gray-600">
                მონაცემთა დაცვა და კონფიდენციალურობა უმაღლეს დონეზე
              </p>
            </div>
            ...
            <div className="card-3d glass-strong rounded-3xl p-8 text-center">
              <div className="text-6xl mb-4">📱</div>
              <h3 className="text-2xl font-bold text-gray-800 mb-3">მობილური</h3>
              <p className="text-gray-600">
                წვდომა ნებისმიერი მოწყობილობიდან, ნებისმიერი ადგილიდან
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <div className="glass-strong rounded-3xl p-12 md:p-16">
            ...
            <Link href="/register" className="inline-block px-10 py-5 bg-emerald-600 text-white text-xl font-semibold rounded-full hover:bg-emerald-700 transition-all hover:scale-110 shadow-2xl hover:shadow-emerald-500/50">
               დაიწყე უფასოდ
            </Link>
          </div>
        </div>
