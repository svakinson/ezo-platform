...
// ============ STEPS CONFIG ============
const steps = [
  { id: 1, title: 'ძირითადი ინფორმაცია', icon: IconBuilding },
  ...
  return (
    <div className="min-h-screen bg-slate-900 relative overflow-x-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute w-96 h-96 top-0 left-0 rounded-full blur-3xl opacity-20 animate-pulse" style={{ background: '#10b981' }} />
        <div className="absolute w-96 h-96 bottom-0 right-0 rounded-full blur-3xl opacity-20 animate-pulse" style={{ background: '#8b5cf6' }} />
      </div>
                ...
                <div key={step.id} className="flex items-center flex-1">
                  <div className="flex flex-col items-center">
                    <div className={`w-12 h-12 rounded-full flex items-center justify-center transition-all duration-300 ${
                      ...
                      {isCompleted ? <IconCheck className="w-6 h-6" /> : <Icon className="w-6 h-6" />}
                    </div>
        ...
        <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 lg:p-12">
          ...
          {currentStep === 1 && (
            <div className="space-y-8">
              <div>
                <h2 className="text-3xl font-bold text-white mb-2">კორპუსის ძირითადი ინფორმაცია</h2>
                <p className="text-white/60">შეავსეთ კორპუსის ზოგადი მონაცემები</p>
              </div>

              <div className="grid md:grid-cols-2 gap-6">
                <div className="md:col-span-2">
                  <label className="block text-sm font-medium text-white/90 mb-2">კორპუსის სახელი (არასავალდებულო)</label>
                  <input
                    type="text"
                ...
                <div className="md:col-span-2">
                  <label className="block text-sm font-medium text-white/90 mb-2">ქუჩა და ნომერი *</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-sm font-medium text-white/90 mb-2">უბანი/რაიონი</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-sm font-medium text-white/90 mb-2">ქალაქი *</label>
                  <select
                    value={formData.city}
                ...
                <div>
                  <label className="block text-sm font-medium text-white/90 mb-2">საფოსტო ინდექსი</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-sm font-medium text-white/90 mb-2">კორპუსის ტიპი *</label>
                  <select
                ...
                <div>
                  <label className="block text-sm font-medium text-white/90 mb-2">აგების წელი</label>
                  <input
                    type="number"
                ...
                <div>
                  <label className="block text-sm font-medium text-white/90 mb-2">სართულების რაოდენობა *</label>
                  <input
                    type="number"
                ...
                <div>
                  <label className="block text-sm font-medium text-white/90 mb-2">ბინების რაოდენობა *</label>
                  <input
                    type="number"
                ...
                <div>
                  <label className="block text-sm font-medium text-white/90 mb-2">სადარბაზოების რაოდენობა *</label>
                  <input
                    type="number"
                ...
                <div>
                  <label className="block text-sm font-medium text-white/90 mb-2">საერთო ფართობი (მ²)</label>
                  <input
                    type="number"
                    value={formData.area}
          ...
          {currentStep === 2 && (
            <div className="space-y-8">
              <div>
                <h2 className="text-3xl font-bold text-white mb-2">მმართველი და საკონტაქტო ინფორმაცია</h2>
                <p className="text-white/60">შეავსეთ მმართველის და საკონტაქტო პირების მონაცემები</p>
              </div>
              ...
              <div className="space-y-6">
                <div className="bg-white/5 rounded-2xl p-6 border border-white/10">
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    <div>
                      <label className="block text-sm font-medium text-white/90 mb-2">სრული სახელი *</label>
                      <input
                        type="text"
                    ...
                    <div>
                      <label className="block text-sm font-medium text-white/90 mb-2">თანამდებობა</label>
                      <input
                        type="text"
                    ...
                    <div>
                      <label className="block text-sm font-medium text-white/90 mb-2">ტელეფონი *</label>
                      <input
                        type="tel"
                    ...
                    <div>
                      <label className="block text-sm font-medium text-white/90 mb-2">ელ-ფოსტა *</label>
                      <input
                        type="email"
                ...
                <div className="bg-white/5 rounded-2xl p-6 border border-white/10">
                  ...
                  <div className="grid md:grid-cols-3 gap-4">
                    <div>
                      <label className="block text-sm font-medium text-white/90 mb-2">სახელი და გვარი</label>
                      <input
                        type="text"
                    ...
                    <div>
                      <label className="block text-sm font-medium text-white/90 mb-2">ურთიერთობა</label>
                      <select
                ...
                <div className="bg-white/5 rounded-2xl p-6 border border-white/10">
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    <div>
                      <label className="block text-sm font-medium text-white/90 mb-2">ბუღალტერი (სახელი)</label>
                      <input
                        type="text"
                    ...
                    <div>
                      <label className="block text-sm font-medium text-white/90 mb-2">ბუღალტერი (ტელეფონი)</label>
                      <input
                        type="tel"
          ...
          {currentStep === 3 && (
            <div className="space-y-8">
              <div>
                <h2 className="text-3xl font-bold text-white mb-2">კომუნალური სერვისები</h2>
                <p className="text-white/60">შეავსეთ კომუნალური მრიცხველების და სერვისების მონაცემები</p>
              </div>
              ...
              <div className="space-y-6">
                ...
                <div className="bg-white/5 rounded-2xl p-6 border border-white/10">
                  ...
                  <div className="grid md:grid-cols-3 gap-4">
                    <div>
                      <label className="block text-sm font-medium text-white/90 mb-2">მიმწოდებელი</label>
                      <select
                    ...
                    <div>
                      <label className="block text-sm font-medium text-white/90 mb-2">მრიცხველის ID</label>
                      <input
                        type="text"
                    ...
                    <div>
                      <label className="block text-sm font-medium text-white/90 mb-2">საწყისი ჩვენება (kWh)</label>
                      <input
                        type="number"
                ...
                <div className="bg-white/5 rounded-2xl p-6 border border-white/10">
                  ...
                  <div className="grid md:grid-cols-3 gap-4">
                    ...
                    <div>
                      <label className="block text-sm font-medium text-white/90 mb-2">საწყისი ჩვენება (m³)</label>
                      <input
                        type="number"
          ...
          {currentStep === 4 && (
            <div className="space-y-8">
              <div>
                <h2 className="text-3xl font-bold text-white mb-2">უსაფრთხოება და დაზღვევა</h2>
                <p className="text-white/60">შეავსეთ უსაფრთხოების სისტემების და დაზღვევის ინფორმაცია</p>
              </div>
              ...
              <div className="space-y-6">
                ...
                <div className="bg-white/5 rounded-2xl p-6 border border-white/10">
                  ...
                  <div className="grid md:grid-cols-3 gap-4">
                    <div>
                      <label className="block text-sm font-medium text-white/90 mb-2">კვამლის დეტექტორები</label>
                      <input
                        type="number"
                    ...
                    <div>
                      <label className="block text-sm font-medium text-white/90 mb-2">უკანასკნელი შემოწმება</label>
                      <input
                        type="date"
                    ...
                    <div>
                      <label className="block text-sm font-medium text-white/90 mb-2">შემდეგი შემოწმება</label>
                      <input
                        type="date"
                ...
                <div className="bg-white/5 rounded-2xl p-6 border border-white/10">
                  ...
                  <div className="space-y-4">
                    <label className="flex items-center gap-3 cursor-pointer">
                      ...
                      />
                      <span className="text-white/90">სათვალთვალო კამერები</span>
                      {formData.hasCameras && (
                        <input
                          type="number"
                          ...
                          placeholder="რაოდენობა"
                          className="ml-4 w-32 px-3 py-2 bg-white/5 border border-white/10 rounded-lg text-white placeholder-white/30 focus:outline-none focus:ring-2 focus:ring-emerald-500/50"
                        />
                      )}
                    </label>
                    <label className="flex items-center gap-3 cursor-pointer">
                      <input
                        ...
                        className="w-5 h-5 rounded border-white/20 bg-white/5 text-emerald-500 focus:ring-emerald-500/50"
                      />
                      <span className="text-white/90">დომოფონი/ვიდეო დომოფონი</span>
                    </label>
                    <label className="flex items-center gap-3 cursor-pointer">
                      <input
                        type="checkbox"
                        ...
                        className="w-5 h-5 rounded border-white/20 bg-white/5 text-emerald-500 focus:ring-emerald-500/50"
                      />
                      <span className="text-white/90">საკონტროლო პუნქტი/დარაჯი</span>
                    </label>
                  </div>
                </div>
                ...
                <div className="bg-white/5 rounded-2xl p-6 border border-white/10">
                  ...
                  <div className="grid md:grid-cols-3 gap-4">
                    <div>
                      <label className="block text-sm font-medium text-white/90 mb-2">სადაზღვევო კომპანია</label>
                      <input
                        type="text"
                    ...
                    <div>
                      <label className="block text-sm font-medium text-white/90 mb-2">პოლისის ნომერი</label>
                      <input
                        type="text"
                    ...
                    <div>
                      <label className="block text-sm font-medium text-white/90 mb-2">ვადის გასვლა</label>
                      <input
                        type="date"
          ...
          {currentStep === 5 && (
            <div className="space-y-8">
              <div>
                <h2 className="text-3xl font-bold text-white mb-2">დოკუმენტები და ფოტოები</h2>
                <p className="text-white/60">ატვირთეთ საჭირო დოკუმენტები და კორპუსის ფოტოები</p>
              </div>
              ...
              <div className="space-y-6">
                ...
                <div className="bg-white/5 rounded-2xl p-6 border border-white/10">
                  ...
                  <div className="space-y-3">
                    {['კორპუსის რეგისტრაციის მოწმობა', 'ტექნიკური პასპორტი', 'სადაზღვევო პოლისი'].map((doc, i) => (
                      <div key={i} className="flex items-center justify-between p-4 bg-white/5 rounded-xl border border-white/10 hover:border-emerald-500/30 transition-colors">
                ...
                <div className="bg-white/5 rounded-2xl p-6 border border-white/10">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    {['ფასადი', 'სადარბაზო', 'ლიფტი', 'ეზო'].map((photo, i) => (
                      <div key={i} className="aspect-square bg-white/5 border-2 border-dashed border-white/20 rounded-xl flex flex-col items-center justify-center hover:border-emerald-500/50 transition-colors cursor-pointer group">
                        <IconCamera className="w-8 h-8 text-white/30 group-hover:text-emerald-400 transition-colors mb-2" />
                        <span className="text-xs text-white/50 group-hover:text-white/70 transition-colors">{photo}</span>
                      </div>
                    ))}
                  </div>
                </div>
                ...
                <div className="bg-white/5 rounded-2xl p-6 border border-white/10">
                  ...
                  <textarea
                    ...
                    rows={4}
                    className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder-white/30 focus:outline-none focus:ring-2 focus:ring-emerald-500/50 focus:border-emerald-500/50 transition-all resize-none"
                  />
                </div>
              </div>
            </div>
          ...
          <div className="flex items-center justify-between mt-12 pt-8 border-t border-white/10">
            <button
              ...
              className="flex items-center gap-2 px-6 py-3 bg-white/10 hover:bg-white/20 disabled:opacity-30 disabled:cursor-not-allowed rounded-xl font-semibold text-white transition-all"
            >
            ...
            {currentStep < 5 ? (
              <button
                onClick={nextStep}
                className="flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 rounded-xl font-semibold text-white shadow-lg shadow-emerald-500/30 hover:shadow-xl hover:shadow-emerald-500/40 transition-all"
              >
                შემდეგი
              ...
              <button
                ...
                className="flex items-center gap-2 px-8 py-3 bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 rounded-xl font-semibold text-white shadow-lg shadow-emerald-500/30 hover:shadow-xl hover:shadow-emerald-500/40 transition-all"
              >
